...
Source: {#BuildDir}\Landis.Extension.SOSIELHarvest-v1.2.dll; DestDir: {#ExtDir}; Flags: ignoreversion
Source: {#BuildDir}\SOSIEL-v2.4.6.dll; DestDir: {#ExtDir}; Flags: ignoreversion

; Requisite auxiliary libraries
; NB. These libraries are used by other extensions and thus are never uninstalled.
Source: {#BuildDir}\Landis.Extension.BiomassHarvest-v4.7.dll; DestDir: {#ExtDir}; Flags: uninsneveruninstall replacesameversion
...
Source: {#BuildDir}\Landis.Library.BiomassHarvest-v3.3.dll; DestDir: {#ExtDir}; Flags: uninsneveruninstall replacesameversion
Source: {#BuildDir}\Landis.Library.Cohorts-v2.dll; DestDir: {#ExtDir}; Flags: uninsneveruninstall replacesameversion
Source: {#BuildDir}\Landis.Library.HarvestManagement-v4.2.dll; DestDir: {#ExtDir}; Flags: uninsneveruninstall replacesameversion
Source: {#BuildDir}\Landis.Library.SiteHarvest-v2.1.dll; DestDir: {#ExtDir}; Flags: uninsneveruninstall replacesameversion
...
[Run]
Filename: {#ExtensionsCmd}; Parameters: "remove ""SOSIEL Harvest v1.2"" "; WorkingDir: {#LandisPlugInDir}
